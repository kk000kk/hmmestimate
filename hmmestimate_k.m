function [tr,E] = hmmestimate_k(seq,states,varargin)
...
tr = sparse(numStates, numStates);
E = sparse(numStates, numSymbols);
...
% for i=1:numStates
%     if trRowSum(i)~=-inf && ERowSum(i)~=-inf
%         tr(i,:) = tr(i,:)/trRowSum(i);
%         E(i,:)= E(i,:)/ERowSum(i);
%     end
% end
